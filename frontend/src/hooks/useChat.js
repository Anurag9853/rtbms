...
const DEMO_RESPONSES = {
  ...
  default:      "I'm connected to the live RTBMS database. I can help you with:\n\n- 🩸 **Blood availability** by group and location\n- 👤 **Donor matching** and eligibility checks\n- 🚨 **Emergency requests** and status updates\n- 📍 **Nearest blood banks** with hours and inventory\n- 📊 **Analytics** and platform statistics\n- 📅 **Upcoming blood drives** in your city\n\nWhat would you like to know?",
};
